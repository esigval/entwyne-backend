...
const downloadAndSaveFiles = async (storylineId, orderDetails) => {
    const order = orderDetails; // Use the passed orderDetails directly
    const videoDir = path.join('/tmp', 'quedVideos');
