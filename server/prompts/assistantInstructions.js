...
// Prompt Schema // Your data output schema (to be iterated over each templatePart). The total output should contain a bracket.
{
    ...
    "primers": ['primer1', 'primer2', 'primer3'] // 2-3 word primers for each prompt
},`;
